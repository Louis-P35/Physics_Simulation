...
{
    m_lightPosition = QVector3D(5.0, 3.0, 12.0);
    //m_cameraPosition = QVector3D(1.0, 3.0, 1.0);
    m_cameraPosition = QVector3D(8.0, 3.0, 14.0);
    //QVector3D cameraLookAt(1.5, 2.75, 1.5);
    QVector3D cameraLookAt(3.5, 2.5, 3.5);
